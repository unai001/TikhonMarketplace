...
class SeccionRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Seccion $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Seccion $entity, bool $flush = true): void
    {
    ...
    public function findSectionById($value):Seccion
    {
        $seccion = $this->getEntityManager()->createQueryBuilder()
            ->select('s')
            ->from(Seccion::class,'s')
            ->andWhere('s.idseccion = :val')
